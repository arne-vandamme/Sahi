	...
	private void startServer() {
		...
		try {
			...
			if ( this.browserType != null ) {
				testRunner = new TestRunner( suite, browserType, baseURL, sahiHost, sahiPort, threads, listReport,
				                             createIssue );
			}
			else {
				testRunner = new TestRunner( suite, browser, baseURL,
				                             sahiHost, sahiPort, threads, browserOption, browserProcessName, listReport,
				                             createIssue );
			}
