...
public class MockResponder
{
	...
	public HttpResponse mockImage( final HttpRequest request ) throws IOException {
		return new HttpFileResponse( Utils.concatPaths( Configuration.getHtdocsRoot(), "spr/mock.gif" ), null, true,
		                             true );
	}
	...
	public HttpResponse simple( final HttpRequest request ) throws IOException {
		...
		HttpResponse mockResponse = new HttpFileResponse( Configuration.getHtdocsRoot() + "spr/simpleMock.htm", props,
		                                                  false, false );
