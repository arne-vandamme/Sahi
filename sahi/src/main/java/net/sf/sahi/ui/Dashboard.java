...
public class Dashboard extends JFrame
{
	...
	private void setTrafficLink( boolean isTrafficEnabled ) {
		...
		trafficLabel.setText(
				( ( isTrafficEnabled ) ? "<html><a href=''><font color='blue'>Enable Traffic Logs</font></a></html>" :
						"<html><a href=''><font color='red'>Disable Traffic Logs</font></a></html>" ) );
	}

	private void refreshTrafficLink() {
		setTrafficLink(
				!( Configuration.isModifiedTrafficLoggingOn() || Configuration.isUnmodifiedTrafficLoggingOn() ) );
	}
				...
				new Thread()
				{
					...
					public void run() {
						...
						String url = "http://" + Configuration
								.getCommonDomain() + "/_s_/dyn/Driver_initialized?browserType=" + browserType.name();
						try {
