...
public class HttpModifiedResponse2 extends HttpResponse
{
	...
	public HttpModifiedResponse2( final HttpResponse response,
	                              final boolean isSSL,
	...
	private boolean isJs() {
		...
		if ( "js".equals( fileExtensionLC ) ||
				...
				fileExtensionLC.endsWith( "js.dsp" ) ) {
			return true;
		}
		return false;
	}
	...
	private boolean isHTML() {
		...
		String contentType = contentTypeHeader();
		if ( contentType != null && ( contentType.toLowerCase().indexOf( "text/html" ) != -1 || contentType
				.toLowerCase().indexOf( "application/xhtml+xml" ) != -1 ) ) {
			return true;
		}
