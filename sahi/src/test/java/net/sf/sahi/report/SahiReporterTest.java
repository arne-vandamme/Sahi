...
public class SahiReporterTest extends MockObjectTestCase
{
	...
	public void testGenerateSuiteReport() {
		...
		mockFormatter.expects( once() ).method( "getSummaryFooter" ).after( "getSummaryHeader" ).will( returnValue(
				"data" ) );
	...
	public void xtestGenerateTestReport() {
		...
		mockFormatter.expects( once() ).method( "getHeader" ).will( returnValue( "data" ) );
		mockFormatter.expects( once() ).method( "getSummaryHeader" ).after( "getHeader" ).will( returnValue( "data" ) );
		mockFormatter.expects( once() ).method( "getSummaryData" ).after( "getSummaryHeader" ).will( returnValue(
				"data" ) );
		mockFormatter.expects( once() ).method( "getSummaryFooter" ).after( "getSummaryData" ).will( returnValue(
				"data" ) );
		mockFormatter.expects( once() ).method( "getStartScript" ).after( "getSummaryFooter" ).will( returnValue(
				"data" ) );
		mockFormatter.expects( once() ).method( "getResultData" ).after( "getStartScript" ).will( returnValue(
				"data" ) );
		mockFormatter.expects( once() ).method( "getStopScript" ).after( "getResultData" ).will( returnValue(
				"data" ) );
