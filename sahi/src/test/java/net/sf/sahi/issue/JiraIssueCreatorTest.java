...
public class JiraIssueCreatorTest extends MockObjectTestCase
{
	...
	protected void setUp() throws Exception {
		...
		mockXmlRpcClient.expects( once() ).method( "execute" ).with( eq( "jira1.login" ), ANYTHING ).will( returnValue(
				"loginToken" ) );
	}
	...
	public void testInitializeXmlRpcClient() throws Exception {
		...
		issueCreator.initializeXmlRpcClient( (XmlRpcClient) mockXmlRpcClient.proxy(),
		                                     (XmlRpcClientConfigImpl) mockConfigImpl.proxy() );
	}
