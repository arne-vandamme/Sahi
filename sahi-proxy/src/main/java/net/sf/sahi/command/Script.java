...
public class Script
{
	...
	public HttpResponse view( String file ) {
		...
		return new HttpFileResponse( net.sf.sahi.config.Configuration.getHtdocsRoot() + "spr/script.htm", props, false,
		                             true );
	}
	...
	HttpResponse dummyFunctions( final HttpRequest request ) {
		...
		return new HttpFileResponse( net.sf.sahi.config.Configuration.getHtdocsRoot() + "spr/dummyFunctions.js", props,
		                             false, true );
	}
}
